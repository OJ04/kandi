...
\usepackage{fancyhdr, lastpage} %automaattinen sivumäärä
...
\title{Sisätilapaikannuksen sovellukset kaupan alalla}
% 2-osainen otsikko:
...
\TITLE{Sisätilapaikannuksen sovellukset kaupan alalla}
%\TITLE{\LaTeX{} för kandidatseminariet med jättelång rubrik som fortsätter och
% fortsätter ännu}
\ENTITLE{Applications for indoor positioning in retail business}
...
\SUPERVISOR{Professori Prof. Juho Rousu}
\INSTRUCTOR{TkT Sakari Luukkainen}
...
%\input{luku_sisalto}
\input{luku_johdanto}
\input{luku_teknologiat}
\input{luku_sovellukset}
\input{luku_tasmamarkkinointi}
\input{luku_yhteenveto}
...
%\bibliographystyle{aaltosci_t_1}
